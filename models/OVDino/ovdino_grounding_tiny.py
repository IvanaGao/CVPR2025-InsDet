...
from models.OVDino.ovdino_enh import OVDINO
from detrex.modeling.matcher.matcher import HungarianMatcher
from detectron2.layers import ShapeSpec


@MODULE_BUILD_FUNCS.registe_with_name(module_name="ovdino_grounding_tiny")
def build_ovdino_grounding_tiny(args, logger=None):
    ...
    dino_transformer_encoder = DINOTransformerEncoder(
        ...
        lang_dim=language_backbone.lang_model.config.hidden_size,
        num_heads=8,
