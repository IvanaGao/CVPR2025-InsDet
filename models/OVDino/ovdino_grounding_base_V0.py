...
from models.OVDino.ovdino_V0 import OVDINO_V0
from detrex.modeling.matcher.matcher import HungarianMatcher
from detectron2.layers import ShapeSpec
from models.visual_prompt_encoder import VPEncoderByDeForAttDecoder


# 支持visual prompt对齐
@MODULE_BUILD_FUNCS.registe_with_name(module_name="ovdino_grounding_base_V0")
def build_ovdino_grounding_base_V0(args, logger=None):
    ...
    # visual prompt 编码器
    visual_prompt_encoder = VPEncoderByDeForAttDecoder(
        layer_num=6,
        embed_dim=args.ovdino_embed_dim,
        device=args.device,
    )
    ...
    model = OVDINO_V0(
        ...
        # test_num_classes=args.test_num_classes,
        ...
        visual_prompt_encoder=visual_prompt_encoder.to(args.device),
    )
