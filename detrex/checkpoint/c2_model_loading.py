...
def convert_basic_c2_names(original_keys):
    ...
    It only deals with typical visual_backbone models.
...
def align_and_update_state_dicts(model_state_dict, ckpt_state_dict, c2_conversion=True):
    ...
    might return visual_backbone[0].body.res2.conv1.weight, while the pre-trained model contains
    ...
    we want to match visual_backbone[0].body.conv1.weight to conv1.weight, and
    visual_backbone[0].body.res2.conv1.weight to res2.conv1.weight.
    """
