...
class EVAViT(Backbone):
    """
    This module implements Vision Transformer (ViT) visual_backbone in :paper:`vitdet`.
...
class SimpleFeaturePyramid(Backbone):
    ...
    def __init__(
        ...
        """
        Args:
            net (Backbone): module representing the subnetwork visual_backbone.
...
def get_vit_lr_decay_rate(name, lr_decay_rate=1.0, num_layers=12):
    ...
    if name.startswith("visual_backbone"):
