...
class BottleneckBlock(CNNBlockBase):
    ...
    def __init__(
        ...
        *,
        ...
        # Add it as an option when we need to use this code to train a visual_backbone.
...
def make_stage(
    ...
    """
    Modified from `detectron2.modeling.visual_backbone.build_resnet_backbone
    ...
    Examples:
    ::
        from detrex.modeling.visual_backbone import make_stage, ResNet, BasicStem
